...
import { JSX, useCallback } from 'react';
 import { ContactCardSelectable, DeleteSelectedContactsButton, SectionHeaderSelection } from 'modules/conversation/contacts/features/contacts-selection'; // Убедитесь, что путь правильный
...
const handleReturnButton = useCallback((): void => {
  ...
  blacklist = [
    ...
    >
        ...
        {!isLoading && !error && (!blacklistResponse || blacklist?.length === 0) && (
