...
import { BlacklistResponse, getBlacklist, GetBlacklistParams } from '../api/blacklist.api';
 ...
 */
export const useGetBlacklist = (params?: GetBlacklistParams): UseQueryResult<BlacklistResponse, unknown> => {
  return useQuery({
